...
echo 'running data collection for run_s8_Town03_repetition_2.sh...'
...
chmod u+x /radar-imaging-dataset/P2SIF/data-collection/Scripts/Job_Files/run_s8_Town03_repetition_2.sh

bash /radar-imaging-dataset/P2SIF/data-collection/Scripts/Job_Files/run_s8_Town03_repetition_2.sh > /radar-imaging-dataset/P2SIF/data-collection/Scripts/logs/job104.log 2>&1
