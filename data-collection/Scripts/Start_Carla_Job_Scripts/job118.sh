...
echo 'running data collection for run_s8_Town10HD_repetition_1.sh...'
...
chmod u+x /radar-imaging-dataset/P2SIF/data-collection/Scripts/Job_Files/run_s8_Town10HD_repetition_1.sh

bash /radar-imaging-dataset/P2SIF/data-collection/Scripts/Job_Files/run_s8_Town10HD_repetition_1.sh > /radar-imaging-dataset/P2SIF/data-collection/Scripts/logs/job118.log 2>&1
