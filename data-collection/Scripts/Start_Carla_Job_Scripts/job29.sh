...
echo 'running data collection for run_s3_Town02_repetition_2.sh...'
...
chmod u+x /radar-imaging-dataset/P2SIF/data-collection/Scripts/Job_Files/run_s3_Town02_repetition_2.sh

bash /radar-imaging-dataset/P2SIF/data-collection/Scripts/Job_Files/run_s3_Town02_repetition_2.sh > /radar-imaging-dataset/P2SIF/data-collection/Scripts/logs/job29.log 2>&1
