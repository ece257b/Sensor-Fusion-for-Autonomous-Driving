...
echo 'running data collection for run_s3_Town07_repetition_1.sh...'
...
chmod u+x /radar-imaging-dataset/P2SIF/data-collection/Scripts/Job_Files/run_s3_Town07_repetition_1.sh

bash /radar-imaging-dataset/P2SIF/data-collection/Scripts/Job_Files/run_s3_Town07_repetition_1.sh > /radar-imaging-dataset/P2SIF/data-collection/Scripts/logs/job43.log 2>&1
