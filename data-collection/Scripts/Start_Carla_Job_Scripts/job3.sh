...
echo 'running data collection for run_s1_Town02_repetition_0.sh...'
...
chmod u+x /radar-imaging-dataset/P2SIF/data-collection/Scripts/Job_Files/run_s1_Town02_repetition_0.sh

bash /radar-imaging-dataset/P2SIF/data-collection/Scripts/Job_Files/run_s1_Town02_repetition_0.sh > /radar-imaging-dataset/P2SIF/data-collection/Scripts/logs/job3.log 2>&1
