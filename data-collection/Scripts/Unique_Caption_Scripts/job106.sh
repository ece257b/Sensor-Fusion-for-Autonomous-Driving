...
touch /radar-imaging-dataset/P2SIF/lidar-radar-clip/caption/job106.json

echo 'running for /radar-imaging-dataset/P2SIF/carla_data/s7_2025-03-05/s7_Town06_Rep1...'

python3 count_unique_captions.py --town_folder /radar-imaging-dataset/P2SIF/carla_data/s7_2025-03-05/s7_Town06_Rep1 --save_file_path /radar-imaging-dataset/P2SIF/lidar-radar-clip/caption/job106.json > /radar-imaging-dataset/P2SIF/data-collection/Scripts/logs/job106.log 2>&1
