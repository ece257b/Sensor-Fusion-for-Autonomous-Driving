...
touch /radar-imaging-dataset/P2SIF/lidar-radar-clip/caption/job107.json

echo 'running for /radar-imaging-dataset/P2SIF/carla_data/s7_2025-03-05/s7_Town06_Rep2...'

python3 count_unique_captions.py --town_folder /radar-imaging-dataset/P2SIF/carla_data/s7_2025-03-05/s7_Town06_Rep2 --save_file_path /radar-imaging-dataset/P2SIF/lidar-radar-clip/caption/job107.json > /radar-imaging-dataset/P2SIF/data-collection/Scripts/logs/job107.log 2>&1
