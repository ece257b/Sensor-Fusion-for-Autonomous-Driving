...
python3 generate_lidar_bev.py --town_folder /radar-imaging-dataset/P2SIF/carla_data/s7_2025-03-05/s7_Town06_Rep2 --lidar_folder_name "lidar" --save_folder_name "lidar_bev_img" > /radar-imaging-dataset/P2SIF/data-collection/Scripts/logs/job107.log 2>&1
