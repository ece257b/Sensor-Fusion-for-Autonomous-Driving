...
python3 generate_lidar_bev.py --town_folder /radar-imaging-dataset/P2SIF/carla_data/s9_2025-03-05/s9_Town06_Rep0 --lidar_folder_name "lidar" --save_folder_name "lidar_bev_img" > /radar-imaging-dataset/P2SIF/data-collection/Scripts/logs/job153.log 2>&1
