...
python3 generate_lidar_bev.py --town_folder /radar-imaging-dataset/P2SIF/carla_data/s3_2025-03-05/s3_Town03_Rep1 --lidar_folder_name "lidar" --save_folder_name "lidar_bev_img" > /radar-imaging-dataset/P2SIF/data-collection/Scripts/logs/job49.log 2>&1
