...
# Evaluation Setup
export ROUTES=/radar-imaging-dataset/P2SIF/data-collection/leaderboard/data/training/routes/s1/Town07_Scenario1.xml
export SCENARIOS=/radar-imaging-dataset/P2SIF/data-collection/leaderboard/data/training/scenarios/s1/Town07_Scenario1.json
...
export CHECKPOINT_ENDPOINT=${SAVE_DIR}/s1_2025-03-05/s1_Town07_Rep0/Results.json # output results file
export SAVE_PATH=${SAVE_DIR}/s1_2025-03-05/s1_Town07_Rep0 # path for saving episodes (comment to disable)
echo 'creating checkpoint and save_path directory...'
sleep 2s
mkdir -p ${SAVE_PATH}
touch ${SAVE_DIR}/s1_2025-03-05/s1_Town07_Rep0/Results.json
echo 'running leaderboard_evaluator_local.py now...'
sleep 3s

cp /radar-imaging-dataset/P2SIF/data-collection/Scripts/Job_Files//run_s1_Town07_repetition_0.sh ${SAVE_DIR}/s1_2025-03-05/s1_Town07_Rep0/
cd ${LEADERBOARD_ROOT}
