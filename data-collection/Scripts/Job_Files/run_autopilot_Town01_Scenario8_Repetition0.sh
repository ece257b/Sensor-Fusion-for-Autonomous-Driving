...
# Evaluation Setup
export ROUTES=/radar-imaging-dataset/P2SIF/data-collection/leaderboard/data/training/routes/s8/Town01_Scenario8.xml
export SCENARIOS=/radar-imaging-dataset/P2SIF/data-collection/leaderboard/data/training/scenarios/s8/Town01_Scenario8.json
...
export CHECKPOINT_ENDPOINT=/radar-imaging-dataset/P2SIF/datagen_carla_garage/hb_dataset_v08_2024_09_09/s8_dataset_2024_09_09/Routes_Town01_Scenario8_Repetition0/Dataset_generation_Town01_Scenario8_Repetition0.json # output results file
export SAVE_PATH=/radar-imaging-dataset/P2SIF/datagen_carla_garage/hb_dataset_v08_2024_09_09/s8_dataset_2024_09_09/Routes_Town01_Scenario8_Repetition0 # path for saving episodes (comment to disable)
echo 'creating checkpoint and save_path directory...'
sleep 2s
mkdir -p ${SAVE_PATH}
touch ${SAVE_PATH}/Dataset_generation_Town01_Scenario8_Repetition0.json
